...
- [ ] **INFRA-010** : Projet React + TanStack Router + Vite
- [ ] **INFRA-011** : Configuration Tailwind CSS 4 + shadcn/ui
- [ ] **INFRA-012** : Client API (fetch wrapper avec auth)
- [ ] **INFRA-013** : Layout de base avec navigation
- [ ] **INFRA-014** : Pages de connexion/inscription
